...
namespace WebApp.Controllers
{
    ...
    public class AccountController : BaseAuthorizeController
    {
        ...
        RoleWebService _roleService = new RoleWebService();
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IUserWebService us)
        ...
        public async Task<ActionResult> Register([CustomizeValidator(RuleSet = "Register")] RegisterUserDto model)
        {
            if (ModelState.IsValid)
            {
                var user = new IdentityUser { FullName=model.FullName, UserName = model.Email, Email = model.Email, CreationDate = Utils.ServerNow };
